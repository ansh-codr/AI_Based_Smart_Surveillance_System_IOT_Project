...
class AppConfig:
    ...
    def from_env():
        return AppConfig(
            red_pin=_env_int("RED_PIN", 27),
            green_pin=_env_int("GREEN_PIN", 17),
            buzzer_pin=_env_int("BUZZER_PIN", 22),
            pir_pin=_env_int("PIR_PIN", 23),
            ...
            faces_dir=os.getenv("FACES_DIR", "/home/pi/Desktop/IOT/known_faces"),
            ...
            firebase_credentials=os.getenv("FIREBASE_CREDENTIALS", os.getenv("GOOGLE_APPLICATION_CREDENTIALS", "")),
